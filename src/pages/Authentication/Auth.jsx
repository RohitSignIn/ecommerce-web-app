...
function Login({setAuthPage}) {
    ...
    return (
        <>
        { page == "Login" && <Auth page={'Login'} setPage={setPage} setAuthPage={setAuthPage} handleForm={handleForm} /> }
        { page == "Signup" && <Auth page={'Signup'} setPage={setPage} setAuthPage={setAuthPage} handleForm={handleForm} /> }
        </>
    )
}
