...
function App() {
  ...
  async function getCart(){
    const cartData = await axios.get(`${cartbyUserId}${cookies.user_id}`, {withcredentials: true})
  ...
  return (
    ...
    <ProductContext.Provider value={{products, setProducts, filterProd, setFilterProd}}>
      <cartContext.Provider value={{cart, setCart}}>
        <Nav setAuthPage={setAuthPage} />
        <div id="mainCon">
        <Suspense fallback={<Loader h={"122px"} jc={"center"} ai={"center"} />}>
          <Category />
        </Suspense>
